<template>
  <modal-create-edit
    ...
    <field v-model="contact.needforchanges[0].clarification" :name="'Clarification (n)'" :size="'half'" />
    <field v-model="contact.influences[0].value" :name="'Influence'" :size="'half'" :field-type="'select'" :options="['low', 'medium', 'high']" />
    <field v-model="contact.influences[0].clarification" :name="'Clarification (i)'" :size="'half'" />
